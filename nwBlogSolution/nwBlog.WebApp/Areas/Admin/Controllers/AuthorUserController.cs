...
namespace nwBlog.WebApp.Areas.Admin.Controllers
{
    ...
    public class AuthorUserController : Controller
    {
        ...
        // GET: Admin/AuthorUser
        public ActionResult Index()
        {
            IndexViewModel model = new IndexViewModel();

            model.Users = _userManager.GetAllRoleAuthorUsers();
        ...
        public ActionResult Create(CreateViewModel model)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                BusinessLayerResult<AppUser> res = _userManager.InsertFromAdmin(user, AppUserManager.UserType.AurhorUser);
